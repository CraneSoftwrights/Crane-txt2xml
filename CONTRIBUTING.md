We welcome feedback and improvements to this project.

# Contributions

[code-of-conduct]: CODE_OF_CONDUCT.md

Contributions to Crane-txt2xml are welcome, but please remember that proposed additions may or may not be incorporated into the main branch based on a thorough review of their applicability and security.
...
At this time, the objective of Crane-txt2xml is to make certain XML markup easy to work with for non-XML'ers.
...
If you’re not a developer but have suggestions about wording, documentation, or usability, feel free to [open a new issue](https://github.com/CraneSoftwrights/Crane-txt2xml/issues/new) — those contributions are just as valued.

## Repository dependency

This repository uses a git submodule at [xslstyle/](xslstyle/) providing stylesheet writing business rule violation exposition from Crane Softwrights Ltd. It is not needed for execution, but is helpful in development.
